...
model = YOLO('C:/Users/enoz00/runs/detect/train5/weights/best.pt')   # 인공지능 모델 경로

cap = cv2.VideoCapture(0)                   # 카메라 기능 켜기
cap.set(cv2.CAP_PROP_FRAME_WIDTH, 1920)      # 카메라 너비 640
cap.set(cv2.CAP_PROP_FRAME_HEIGHT, 1080)     # 카메라 높이 480
